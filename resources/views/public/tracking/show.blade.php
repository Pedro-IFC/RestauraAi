...
@section('content')
    <div class="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <a href="{{ route('public.account.index', $tenant->slug) }}" class="w-fit rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">
            Minha Conta
        </a>
    </div>
